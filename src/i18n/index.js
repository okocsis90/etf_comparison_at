const translations = {
  de: {
    ...
    etfComparison: {
      ...
      staleResults: 'Ihre Eingaben haben sich geändert. Klicken Sie auf "Neu berechnen", um den Vergleich zu aktualisieren.',
      need_at_least_two: 'Mindestens 2 ETFs müssen erfolgreich geladen werden, um einen Vergleich anzuzeigen.',
    },
    reportTable: {
      title: 'Berichtsdetails',
      colDate: 'Berichtsdatum',
      colDeemedEur: 'Ausschüttungsgleiche Erträge (EUR)',
      colPriceEur: 'ETF-Preis (EUR)',
      colDeemedPct: 'Ausschüttungsgl. / Preis',
    },
    reportChart: {
      title: 'Jährliche Berichtsmetriken',
      deemedIncome: 'Ausschüttungsgleiche Erträge',
      etfPrice: 'ETF-Preis',
      deemedPct: 'Ausschüttungsgl. / Preis %',
    },
    confidence: {
      badge_label: 'DATENQUALITÄT',
      title: 'Datenvertrauen — {label}',
      based_on: 'Basierend auf {n} Jahresberichten',
      legend: 'Vorläufig (<3) · Begrenzt (3–4) · Moderat (5–6) · Zuverlässig (7–8) · Umfassend (9+)',
      levels: {
        1: 'Vorläufig',
        2: 'Begrenzt',
        3: 'Moderat',
    ...
    taxBadge: {
      title: 'Steuereffizienz (AT) — {score}/100',
      taxBurden: 'Steuerbelastung',
      avg_deemed_prefix: 'durchschn. Ausschüttungsgl./Preis:',
      consistency: 'Konsistenz',
      deemed_label: 'Ausschüttungsgl. / Gewinne',
      of_total_gains: 'des jährlichen Anteils an Gesamtgewinnen',
      deemed_excluded: 'ausgeschlossen (Gewinne nicht positiv oder Verhältnis außerhalb des Bereichs)',
      click_for_methodology: 'Für vollständige Methodik klicken',
    },
      scoreDialog: {
      header: 'Steuereffizienz-Score: {score} / 100',
      header_sub: 'Wie Ihr ETF für österreichische Steuerzwecke bewertet wird',
      taxBurden_title: 'Steuerbelastung',
      ...
      cv_neutral_applied: 'Neutral: 50 Punkte angewendet — CV undefiniert',
  ...
  en: {
    ...
    etfComparison: {
      ...
      staleResults: 'Your inputs have changed. Click Recalculate to update the comparison.',
    ...
    confidence: {
      ...
      based_on: 'Based on {n} yearly reports',
    ...
    scoreDialog: {
      ...
      taxBurden_formula: 'score = max(0, 100 × (1 − avg% / 3))',
      taxBurden_plain: 'In plain terms: we map the average annual deemed % to a 0–100 score with 0 % → 100 and 3 % → 0.',
